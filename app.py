...
def handle_editor(message):
    bot.send_message(message.chat.id,
                     text='*СЛИШКОМ МНОГО БУКВ 😳😳😳*\n*ИЛИ СЛИШКОМ МНОГО КАРТИНОК 😳😳😳*\Возможно, вы ввели '
                          'большой текст и телеграм автоматически разделил его на несколько частей, так как у '
                          'телеграмма есть свои ограничения по количеству символов в посте.\nЕсли вы заполняли '
                          'расписание, то в расписание попала лишь часть введённого вами текста или первое загруженное'
                          ' вами фото:(\nВам нужно проверить расписание, сократить текст, иначе вы не сможете '
                          'анонсировать ваши игры одним сообщением.\nОтредактируйте ваше расписание :)'
